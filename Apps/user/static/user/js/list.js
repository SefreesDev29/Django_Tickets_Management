        ...
        buttons: [
            ...
            },
            {
                ...
                customize: function (doc) {
                    ...
                    doc.content[1].table.widths = ['6%', '15%', '15%','18%','18%','13%','15%'];
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if(row.is_active)
                    {
                        ...
                        html += '<span class="badge badge-danger">Desactivado</span> ';
                    }
                    return html;
                }
            },
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if(row.is_superuser)
                    {
                        buttons += '<a href="/user/update/' + row.id + '/" class="btn btn-warning btn-xs btn-flat btn-custom-icon" data-toggle="tooltip" title="Editar Registro"><i class="fas fa-edit"></i></a> ';   
                    }else{
                        buttons += '<a href="/user/update/' + row.id + '/" class="btn btn-warning btn-xs btn-flat btn-custom-icon" data-toggle="tooltip" title="Editar Registro"><i class="fas fa-edit"></i></a> ';
                        buttons += '<a href="/user/delete/' + row.id + '/" type="button" class="btn btn-danger btn-xs btn-flat btn-custom-icon" data-toggle="tooltip" title="Eliminar Registro"><i class="fas fa-trash-alt"></i></a>';
                    } 
                   return buttons;
                }
            },
