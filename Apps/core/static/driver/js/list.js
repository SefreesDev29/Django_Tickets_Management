        ...
        buttons: [
            ...
            },
            {
                ...
                customize: function (doc) {
                    ...
                    doc.content[1].table.widths = ['5%', '23%', '23%', '14%','20%', '15%'];
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a href="/menu/driver/update/' + row.id + '/" class="btn btn-warning btn-xs btn-flat btn-custom-icon" data-toggle="tooltip" title="Editar Registro"><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="/menu/driver/delete/' + row.id + '/" type="button" class="btn btn-danger btn-xs btn-flat btn-custom-icon" data-toggle="tooltip" title="Eliminar Registro"><i class="fas fa-trash-alt"></i></a>';
                    return buttons;
                }
            },
        ],
